...
def bravdafunction(forecastdate, obsToAssim='C', usecustomens=True, runoutputdir='', plottimeseries=True, corona='MAS',
                   precondState=False):
    ...
    rbe.runBravDA(configFile, huxVarFile, outputDir, obsToAssim, setupOfR, initDate, noOfConsecWindows, noOfMASens,
                  locRad, gTol, makePlots, usecustomens=usecustomens, precondState=precondState)
...
if __name__ == "__main__":
    ...
    precondState = True
    # Run BRaVDA function
    bravdafunction(fcDate, obsToAssim=["STERA", "STERB"], usecustomens=False, runoutputdir='', plottimeseries=True,
        corona='MAS', precondState=precondState)
