...
def readObsFileAvg(obsFile, mjdFile, initTime, finalTime):
    ...
    for ln in vObsLines:
        ...
        doY = int(s[1].strip())
        hr = int(s[2].strip())
        # print('Year, doy, hour: ', year, doY, hr)
        MJDtime = gregToMJD(year, doY, hr)
        # print('MJD time: ', MJDtime)
    ...
    print('Obs all len:', len(obsAll))
    print('Obs MJD time len: ', len(obsMJDtime))
    print(obsMJDtime[0])
    print(obsAll[0])
